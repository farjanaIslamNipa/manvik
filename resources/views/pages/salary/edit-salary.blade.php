     ...
     @include('employee.inclueds.emplye-common-nav')
      <div class="row justify-content-center">
        <div class="col-xl-7 col-md-10">
          <div class="card mt-4">
            <h4 class="text-lg text-center pt-4 pb-2 font-bold">Salary Information</h4>
            <form action="{{ route('admin.store.employee') }}" method="POST" class="base-form">
              @csrf
              <div class="card-body pb-1">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-10 col-sm-9 px-5">
                    <input type="text" class="form-control" value="{{ old('fathers_name') }}" name="fathers_name" placeholder="Enter Father's name" />
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-10 col-sm-9 px-5">
                    <input type="text" class="form-control" name="nid" value="{{ old('nid') }}" placeholder="Enter NID number" />
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-10 col-sm-9 px-5">
                      <input type="text" class="form-control" name="salary" value="{{ old('salary') }}" placeholder="Enter salary amount" />
