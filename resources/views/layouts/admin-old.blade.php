                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    @foreach ($users as $user)
                                        <li><a class="dropdown-item bg-dark text-white"
                                                href="{{ route('admin.users.assign.role.view', $user->id) }}">{{ $user->name }}</a>
                                        </li>
                                    @endforeach
                        ...
                        @role('admin')
                            ...
                            <li class="sidebar-item">
                                ...
                                <ul aria-expanded="false" class="collapse first-level bg-secondary">
                                    <li class="sidebar-item">
                                        <a href="{{ route('admin.all.employee.show') }}"
                                            class="sidebar-link {{ request()->routeIs('admin.all.employee.show') ? 'active-menu' : '' }}"><span
                                                class="hide-menu ms-2">
                                                <span class="sub-menu-icon"><i class="fa-solid fa-caret-right"></i></span>
                                                Employee Details
                                            </span>
                                        </a>
                            ...
                            <div class="ps-1">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <a onclick="event.preventDefault(); this.closest('form').submit();"
                                        ...
                                        <i class="fa fa-power-off me-1 ms-1"></i> <span
                                          class="log-out hide-menu">Logout</span>
                                    </a>
                                </form>
                            </div>
                        </li>
